...
## Active Technologies
- JavaScript/TypeScript with Node.js v18+ (for Docusaurus) + Docusaurus 2.x, React, Node.js, npm (001-physical-ai-course)
- Static files (Markdown content in docs/, code examples in examples/) (001-physical-ai-course)

## Recent Changes
- 001-physical-ai-course: Added JavaScript/TypeScript with Node.js v18+ (for Docusaurus) + Docusaurus 2.x, React, Node.js, npm
